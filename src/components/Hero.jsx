    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-2 pt-2">
              ...
              <div className="flex flex-wrap gap-2">
                {techBadges.map((tech) => (
                  <div
                    key={tech.name}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-zinc-900/80 border border-white/10 text-xs font-mono text-zinc-300 hover:border-white/30 hover:text-white transition-all shadow-sm"
                  >
                    {tech.icon}
                    <span>{tech.name}</span>
                  </div>
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="px-5 py-2.5 rounded-md bg-white text-black font-mono text-xs font-semibold hover:bg-zinc-200 transition-all flex items-center gap-2 shadow-sm"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="px-5 py-2.5 rounded-md bg-zinc-900 border border-white/10 hover:border-white/30 text-zinc-300 hover:text-white font-mono text-xs font-medium transition-all flex items-center gap-2"
              >
          ...
          >
            <div className="rounded-xl overflow-hidden bg-zinc-950 border border-white/10 shadow-2xl shadow-black">
              {/* Window Header */}
